...
import { CreateSchool } from '../../app/use-cases/schools/create-school';
import { CreateCourse } from '../../app/use-cases/courses/create-course';
import { CreateCourseClass } from '../../app/use-cases/courses/create-course-class';
import { UpdateCourseClass } from '../../app/use-cases/courses/update-course-class';
...
import { ScheduleClassSession } from '../../app/use-cases/courses/schedule-class-session';
import { ListClassSessions } from '../../app/use-cases/courses/list-class-sessions';
import { CancelClassSession } from '../../app/use-cases/courses/cancel-class-session';
...
import { LoginSchool } from '../../app/use-cases/auth/login-school';
import { SchoolPlanFinanceRepositoryAdapter } from '../../infra/db/typeorm/school-plan-finance-repository.adapter';
import { GetActiveSchoolPlan } from '../../app/use-cases/schools/get-active-school-plan';
import { SubscriptionPlanRepositoryAdapter } from '../../infra/db/typeorm/subscription-plan-repository.adapter';
import { ListSubscriptionPlans } from '../../app/use-cases/catalog/list-subscription-plans';
import { AssignSchoolPlan } from '../../app/use-cases/schools/assign-school-plan';
import { CategoryRepositoryAdapter } from '../../infra/db/typeorm/category-repository.adapter';
import { ListCategories } from '../../app/use-cases/catalog/list-categories';
...
import { GetSchoolCourse } from '../../app/use-cases/schools/get-school-course';
import { ListCourseClasses } from '../../app/use-cases/courses/list-course-classes';
import { GetCourseClass } from '../../app/use-cases/courses/get-course-class';
import { GetSchoolProfile } from '../../app/use-cases/schools/get-school-profile';
...
import { ResendSchoolAsaasBankAccount } from '../../app/use-cases/schools/resend-school-asaas-bank-account';
import { UpdateCourse } from '../../app/use-cases/courses/update-course';
import { DeleteCourse } from '../../app/use-cases/courses/delete-course';
import { SchoolPlanInvoiceRepositoryAdapter } from '../../infra/db/typeorm/school-plan-invoice-repository.adapter';
import { IssueSchoolPlanInvoice } from '../../app/use-cases/schools/issue-school-plan-invoice';
...
import { HandleAsaasPaymentWebhook } from '../../app/use-cases/payments/handle-asaas-payment-webhook';
import { HandleAsaasAccountWebhook } from '../../app/use-cases/payments/handle-asaas-account-webhook';
import { HandleAsaasTransferWebhook } from '../../app/use-cases/payments/handle-asaas-transfer-webhook';
import { asaasWebhookRouter } from '../../infra/http/routes/webhooks/asaas.routes';
import { ListSchoolPlanInvoices } from '../../app/use-cases/schools/list-school-plan-invoices';
import { GetSchoolPlanInvoicePix } from '../../app/use-cases/schools/get-school-plan-invoice-pix';
...
import { ListPaidSchoolPayments } from '../../app/use-cases/schools/list-paid-school-payments';
import { ConsolidateSchoolPayments } from '../../app/use-cases/schools/consolidate-school-payments';
...
import { CreateSchoolCharge } from '../../app/use-cases/schools/create-school-charge';
import { GetSchoolFinancialSummary } from '../../app/use-cases/schools/get-school-financial-summary';
import { SchoolMarkChargePaid } from '../../app/use-cases/schools/school-mark-charge-paid';
import { SchoolDeleteCharge } from '../../app/use-cases/schools/school-delete-charge';
import { GetSchoolDashboard } from '../../app/use-cases/schools/get-school-dashboard';
import { ListSchoolWithdrawals } from '../../app/use-cases/schools/list-school-withdrawals';
import { RequestSchoolWithdrawal } from '../../app/use-cases/schools/request-school-withdrawal';
...
import { ListSchoolBankAccounts } from '../../app/use-cases/schools/list-school-bank-accounts';
import { CreateSchoolBankAccount } from '../../app/use-cases/schools/create-school-bank-account';
import { UpdateSchoolBankAccount } from '../../app/use-cases/schools/update-school-bank-account';
import { DeleteSchoolBankAccount } from '../../app/use-cases/schools/delete-school-bank-account';
import { ResetPassword } from '../../app/use-cases/auth/reset-password';
...
import { UpdateSchoolPassword } from '../../app/use-cases/schools/update-school-password';
...
import { GetSchoolStudentDetails } from '../../app/use-cases/schools/get-school-student-details';
import { ListSchoolStudentPaidCharges } from '../../app/use-cases/schools/list-school-student-paid-charges';
import { ConsolidateSchoolStudentFinancial } from '../../app/use-cases/schools/consolidate-school-student-financial';
import { StorageProviderPort } from '../../ports/providers/storage-provider.port';
import { UploadSchoolImage } from '../../app/use-cases/schools/upload-school-image';
import { ListSchoolImages } from '../../app/use-cases/schools/list-school-images';
...
import { ValidateSchoolCoupon } from '../../app/use-cases/schools/validate-school-coupon';
import { NotificationRepositoryAdapter } from '../../infra/db/typeorm/notification-repository.adapter';
import { ListSchoolNotifications } from '../../app/use-cases/schools/list-school-notifications';
...
import { SendClassPushNotification } from '../../app/use-cases/schools/send-class-push-notification';
import { NotifyStudentUser } from '../../app/use-cases/shared/notify-student-user';
import { GetSchoolNotificationPreferences } from '../../app/use-cases/schools/get-school-notification-preferences';
import { UpdateSchoolNotificationPreferences } from '../../app/use-cases/schools/update-school-notification-preferences';
import { ReadSchoolNotification } from '../../app/use-cases/schools/read-school-notification';
import { ReadAllSchoolNotifications } from '../../app/use-cases/schools/read-all-school-notifications';
...
import { ConsumeSchoolActionOtp } from '../../app/use-cases/shared/consume-school-action-otp';
import { RequestSchoolActionOtp } from '../../app/use-cases/schools/request-school-action-otp';
import { VerifySchoolActionOtp } from '../../app/use-cases/schools/verify-school-action-otp';
import { EnrollmentProgressRepositoryAdapter } from '../../infra/db/typeorm/enrollment-progress-repository.adapter';
import { ListSchoolStudentLevels } from '../../app/use-cases/schools/list-school-student-levels';
import { CreateSchoolStudentLevel } from '../../app/use-cases/schools/create-school-student-level';
import { ListSchoolCertificateTemplates } from '../../app/use-cases/schools/list-school-certificate-templates';
import { CreateSchoolCertificateTemplate } from '../../app/use-cases/schools/create-school-certificate-template';
import { GetEnrollmentProgressOverview } from '../../app/use-cases/schools/get-enrollment-progress-overview';
import { RecordEnrollmentLevelPromotion } from '../../app/use-cases/enrollments/record-enrollment-level-promotion';
import { AppendEnrollmentTimelineEvent } from '../../app/use-cases/enrollments/append-enrollment-timeline-event';
...
export function buildSchoolsModule(deps: SchoolsModuleDeps, ctx: ModuleSetupContext): ModuleBuildResult {
    ...
    const updateSchool = new UpdateSchool(deps.schoolsRepo, deps.passwordHasher, deps.usersRepo);
    ...
    const schoolDeleteCharge = new SchoolDeleteCharge(
        deps.financialChargesRepo,
        deps.schoolsRepo,
        deps.paymentProvider
    );
    ...
    const handleAsaasTransferWebhook = new HandleAsaasTransferWebhook(withdrawalsRepo, deps.schoolsRepo, deps.outbox);
