...
export class RemoveSchoolCategories1000000000012 implements MigrationInterface {
    name = 'RemoveSchoolCategories1000000000012';

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query('DROP TABLE IF EXISTS school_category_subcategories');
        await queryRunner.query('DROP TABLE IF EXISTS school_subcategories');
